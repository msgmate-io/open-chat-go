...
export const NewMessageButton = ({ onClick }: { onClick: () => void }) => {
    return <div className="flex p-2 rounded-xl hover:bg-base-100" onClick={onClick}>
        <NewMessageSvgIcon />
    </div>
}

const NewMessageSvgIcon = (props: any) => (
    <svg
    ...
    return <Card className="border-0 bg-base-200 p-2 flex shadow-none z-10" key={"chatListHeader"}>
        ...
        <div className="flex flex-grow items-center content-center justify-start">
            ...
            <NewMessageButton onClick={() => {
                // TODO navigateTo(null, { chat: "create", userName: "hal" })
            }} />
        </div>
    </Card>
}